...
{{--
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jexcel/2.1.0/css/jquery.jexcel.css"
  type="text/css" /> --}}
{{--
      ...
      <div class="card card-custom">
        <div class="card card-custom gutter-b">
          ...
          <div class="card-body">
            ...
            <div class="mt-10 mb-5 collapse" id="kt_datatable_group_action_form">
              <div class="d-flex align-items-center">
                ...
                <div class="dropdown mr-2">
                  <button type="button" class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown">Update
                    status</button>
            ...
            <!--begin: Datatable-->
            <table class="table datatable datatable-bordered table-hover datatable-head-custom"
              id="daily-collection-table">
              <thead>
                <tr>
                  <th>Date</th>
                  <th>Account Name</th>
