<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu mb-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							<!--begin::Menu Nav-->
							<ul class="menu-nav">
								<li class="menu-item @if(Route::current()->getName() == 'dashboard') {{ 'menu-item-active' }}@endif" aria-haspopup="true">
                ...
                {{-- menu-item-active --}}
                      ...
                      <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
												<a href="/client/loan-status @if(Route::current()->getName() == 'client-info') {{ 'menu-item-active' }} @endif" class="menu-link">
                          <i class="menu-bullet menu-bullet-line">
														<span></span>
													</i>
                ...
                <li class="menu-item menu-item-submenu @if(Route::current()->getName() == 'collection') {{ 'menu-item-active' }} @endif" aria-haspopup="true" data-menu-toggle="hover">
