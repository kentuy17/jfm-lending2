var KTDatatableRecordSelectionDemo = function () {
  ...
  var options = {
    ...
    columns: [
      ...
      //           pending: {'title': 'Pending', 'class': ' label-light-danger'},
      //           inactive: {'title': 'Inactive', 'class': ' label-light-info'},
  ...
  var localSelectorDemo = function () {
    ...
    var datatable = $('#kt_datatable').DataTable(options);
  ...
  var serverSelectorDemo = function () {
    ...
    var datatable = $('#kt_datatable_2').DataTable(options);
